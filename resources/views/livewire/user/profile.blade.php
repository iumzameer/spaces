<div class="bg-gray-50 text-gray-800 min-h-screen">
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6 bg-white shadow-lg rounded-lg p-6">
          <!-- Name -->
          <div>
            <label class="block text-gray-700 text-sm font-bold mb-2">Name</label>
            <input type="text" placeholder="Enter your name" value="{{\Auth::user()->name}}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:shadow-outline" required>
          </div>

          <!-- NID No -->
          <div>
            <label class="block text-gray-700 text-sm font-bold mb-2">NID No</label>
            <input type="text" placeholder="Enter your NID No" value="{{\Auth::user()->nid}}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:shadow-outline" required>
          </div>

          <!-- Contact No -->
          <div>
            <label class="block text-gray-700 text-sm font-bold mb-2">Contact No</label>
            <input type="text" placeholder="Enter your contact number" value="{{\Auth::user()->contact}}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:shadow-outline" required>
          </div>

          <!-- Email -->
          <div>
            <label class="block text-gray-700 text-sm font-bold mb-2">Email</label>
            <input type="email" placeholder="Enter your email" value="{{\Auth::user()->email}}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:shadow-outline" required>
          </div>

          <!-- Present Address -->
          <div>
            <label class="block text-gray-700 text-sm font-bold mb-2">Present Address</label>
            <input type="text" placeholder="Enter your present address" value="{{\Auth::user()->address}}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:shadow-outline" required>
          </div>

          <!-- Permanent Address -->
          <div>
            <label class="block text-gray-700 text-sm font-bold mb-2">Permanent Address</label>
            <input type="text" placeholder="Enter your permanent address" value="{{\Auth::user()->paddress}}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:shadow-outline" required>
          </div>
        </div>
        <div class="p-6 mt-5">
            <div class="flex justify-center" bis_skin_checked="1">
               <button class="w-1/6 mt-4 py-3 bg-green-500 text-white rounded hover:bg-green-600" wire:click="saveProfile">Save</button>
           </div>
        </div>
        <header class="flex items-center justify-between mb-2 mt-10">
